...
std::string dirNameTest("Data/kaggleDiabeticRetinopathy/500_sample/");
...
int main() {
  ...
  testSet.summary();
  {
    ...
    cnn.processDatasetRepeatTest(testSet, batchSize,6,"Data/kaggleDiabeticRetinopathy/kaggleDiabetes3_epoch46.test");
  }
}
